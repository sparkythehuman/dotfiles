...
brew install bash # modern version of bash
brew install coreutils # the GNU tools tend to be more powerful and useful than the Apple/BSD versions
brew install trash-cli # trash helper, used in place of rm